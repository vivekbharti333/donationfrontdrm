export class routes {
  ...
  public static get addDonation(): string {
    return this.donationManagement + '/add-donation';
  }
  ...
  public static get paymentModeManagement(): string {
    return this.core + '/payment-mode-management';
  }
  public static get paymentModeMaster(): string {
    return this.paymentModeManagement + '/payment-mode-master';
  }
  public static get paymentMode(): string {
    return this.paymentModeManagement + '/payment-mode';
  }

  //Program Management
  public static get programManagement(): string {
    return this.core + '/program-management';
  }
  public static get program(): string {
    return this.programManagement + '/program';
  }

  //Currency Management
  public static get currencyManagement(): string {
    return this.core + '/currency-management';
  }
  public static get currencyMaster(): string {
    return this.currencyManagement + '/currency-master';
  }
  ...
  public static get addReceiptHeader(): string {
    return this.receiptManagement + '/add-receipt-header';
  }
  ...
  public static get studentAcademic(): string {
    return this.schoolManagement + '/student-academic';
  }
  public static get feeType(): string {
    return this.schoolManagement + '/fee-type';
  }
