  ...
  saveCompanyDetails(comapny: any, selectedSuperadminId?: string): Observable<any> {
    let request: any = {
      payload: {
        ...
        crmDisplayLogoLong: comapny.crmDisplayLogoLong,
        crmDisplayLogoSmall: comapny.crmDisplayLogoSmall,
        displayName: comapny.displayName,
        emailId: comapny.emailId,
        website: comapny.website,
        phoneNumber: comapny.phoneNumber,
        service: comapny.service || this.loginUser['service'] || this.cookieService.get('service'),
